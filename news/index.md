...
- Every guide now opens with what it answers, what you need and what it
  cannot establish, and ends with a “Next” section. The website lists
  the guides in reading order.
- “Path” now always means a way through the survey its design allows,
  and “route” what one respondent actually did; both are in the
  vocabulary table, which is now also in the README.
