...
Real route data would come from your fielded response file: count
each respondent's loop iterations and flag which optional blocks they
entered. When `routes` are supplied the report's verdict line also
