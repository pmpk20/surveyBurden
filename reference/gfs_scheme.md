...
[doi:10.32866/001c.125481](https://doi.org/10.32866/001c.125481) ). The
...
A named list of point values and conversion parameters.
...
- `points_per_minute`:
  ...
  2024). Overridable: set `s$points_per_minute` on the returned list, or
