...
- `vignette("realised-burden")` -- scoring the questions each respondent
  actually answered from response data.
- `vignette("extensions")` -- scoring surveys without a QSF: the
  intermediate representation and how to extend to other platforms.
